...
/* harmony import */ var _out_components_detallesHabitacion_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @out/components/detallesHabitacion.vue */ "./resources/js/src/views/out/components/detallesHabitacion.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    detallesHabitacion: _out_components_detallesHabitacion_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  props: {
    reservacion: {
      type: Object,
...
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/linksCSS.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: (_components = {
    LinkCSS: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/linksCSS.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    ...
    [
      ...
      _c("div", { staticClass: "package-item" }, [
        ...
        _c("div", { staticClass: "d-flex border-bottom" }, [
          _c(
            ...
            [
              ...
              _vm._v(
                " " +
                  _vm._s(_vm.item.puedeFumar ? "Si " : "No ") +
                  "se puede fumar"
              ),
            ]
          ),
        ...
        _c("div", { staticClass: "text-center p-4" }, [
          _c("h3", { staticClass: "mb-0" }, [_vm._v(_vm._s(_vm.item.nombre))]),
          _vm._v(" "),
          _c("h3", { staticClass: "mb-0" }, [_vm._v(_vm._s(_vm.item.tarifa))]),
          _vm._v(" "),
          _vm._m(0),
          _vm._v(" "),
          ...
          _c("div", { staticClass: "d-flex justify-content-center mb-2" }, [
            _c(
              "button",
              {
                ...
                on: {
                  click: function ($event) {
                    return _vm.handleShowModal(_vm.item)
                  },
                },
              },
              [_vm._v("Read More")]
