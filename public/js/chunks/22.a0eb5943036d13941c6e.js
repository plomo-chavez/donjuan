...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    handleIsSelected: function handleIsSelected(data) {
      var tmp = this.buscarPorPropiedad(this.reservacion.habitaciones, 'id', data.id);
        ...
        : _vm._l(_vm.habitaciones, function (habitacion, index) {
            return _c("detallesHabitacion", {
              ...
              attrs: {
                ...
                isSelected: function () {
                  _vm.handleIsSelected(habitacion)
                },
              },
              on: {
