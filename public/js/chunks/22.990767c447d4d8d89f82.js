    ...
    peticionAdministrar: function peticionAdministrar(payload) {
      ...
      _apis_usePeticiones__WEBPACK_IMPORTED_MODULE_14__["default"].administrarReservaciones({
        ...
        if (response.data.result) {
          ...
          _this2.showMessageConfirm = true;
        }
...
/* harmony import */ var _currentComponents_customSelect_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @currentComponents/customSelect.vue */ "./resources/js/src/views/currentComponents/customSelect.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    customSelect: _currentComponents_customSelect_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  data: function data() {
    return {
      locate: {
...
/* harmony import */ var core_js_modules_es_array_map_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/modules/es.array.map.js */ "./node_modules/core-js/modules/es.array.map.js");
/* harmony import */ var core_js_modules_es_array_map_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_map_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _apis_useCatalogo__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/apis/useCatalogo */ "./resources/js/src/apis/useCatalogo.js");
/* harmony import */ var _currentComponents_detailsRoom_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @currentComponents/detailsRoom.vue */ "./resources/js/src/views/currentComponents/detailsRoom.vue");
/* harmony import */ var _currentComponents_administracion_reservaciones_ExtraDetailsRoom_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @currentComponents/../administracion/reservaciones/ExtraDetailsRoom.vue */ "./resources/js/src/views/administracion/reservaciones/ExtraDetailsRoom.vue");
/* harmony import */ var _out_components_detallesHabitacion_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @out/components/detallesHabitacion.vue */ "./resources/js/src/views/out/components/detallesHabitacion.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    detallesHabitacion: _out_components_detallesHabitacion_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    extraDetailsRoom: _currentComponents_administracion_reservaciones_ExtraDetailsRoom_vue__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  props: {
    reservacion: {
      type: Object,
  ...
  computed: {
    lengthHabitaciones: function lengthHabitaciones() {
      var _this$reservacion$hab, _this$reservacion$hab2;
      return (_this$reservacion$hab = (_this$reservacion$hab2 = this.reservacion.habitaciones) === null || _this$reservacion$hab2 === void 0 ? void 0 : _this$reservacion$hab2.length) !== null && _this$reservacion$hab !== void 0 ? _this$reservacion$hab : 0;
    }
  },
  beforeMount: function beforeMount() {
  ...
  methods: {
    ...
    sincronizarHabitaciones: function sincronizarHabitaciones(habitacionesDisponibles) {
      console.log('sincronizarHabitaciones');
      var tmp = [];
      // Filtra el array de habitaciones seleccionadas para mantener solo aquellas que también están en habitaciones disponibles.
      // Esto se asume que la comparación se basa en algún identificador único de las habitaciones, como un 'id'.
      tmp = this.reservacion.habitaciones.filter(function (habitacionSeleccionada) {
        return habitacionesDisponibles.some(function (habitacionDisponible) {
          return habitacionDisponible.id === habitacionSeleccionada.id;
        });
      });
      console.log(tmp);
      this.handleSeleccionarHabitacion(tmp);
    },
    getHabitaciones: function getHabitaciones() {
      ...
      _apis_useCatalogo__WEBPACK_IMPORTED_MODULE_7__["default"].roomsAvailable({
        filtros: filtros
      }).then(function (response) {
        ...
        _this.sincronizarHabitaciones(tmp);
    ...
    [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("b-card-body", { staticClass: "p-0 m-0" }, [
            _vm.showMessageConfirm
              ? _c("div", { staticClass: "col-10 my-auto mx-auto" }, [
                  ...
                  _c("h6", { staticClass: "col-12 mb-1" }, [
                    _c("strong", [
                      _vm._v(
                        "¡Nos emociona ser parte de tu próxima experiencia!"
                      ),
                    ]),
                  ]),
                  _vm._v(" "),
    ...
    _c(
      ...
      [
        ...
        _c("customSelect", {
          staticClass: "col p-0 m-0",
          attrs: {
            input: _vm.configSelect,
            formValue: _vm.reservacion.motivoViaje,
          },
          on: {
            changeData: function (data) {
              var tmp = {}
              tmp[data.field] = data.value
              _vm.handleChangeReservacion(tmp)
            },
          },
        }),
      ],
  ...
  return _c(
    ...
    [
      _vm.dataActive != null
        ...
        : [
            _vm.habitaciones.length == 0
              ? _c("div", [
                  _c("h3", { staticClass: "text-center " }, [
                    _vm._v("Habitaciones no disponibles"),
                  ]),
                  _vm._v(" "),
                  _c("p", { staticClass: "text-center " }, [
                    _vm._v("Lo sentimos, no hay habitaciones disponibles del "),
                    _c("strong", [_vm._v(_vm._s(_vm.reservacion.fechaInicio))]),
                    _vm._v(" al "),
                    _c("strong", [_vm._v(_vm._s(_vm.reservacion.fechaFin))]),
                    _vm._v(
                      ". Te recomendamos seleccionar nuevas fechas de búsqueda o explorar otras categorías de habitaciones."
                    ),
                  ]),
                  _vm._v(" "),
                  _c("p", { staticClass: "text-center " }, [
                    _vm._v(
                      "¡Estamos aquí para ayudarte a encontrar la estancia perfecta!"
                    ),
                  ]),
                ])
...
var render = function () {
  ...
  return _c("div", [
    _c("div", { staticClass: "col-10 my-auto mx-auto" }, [
      _c("h3", { staticClass: "col-12 text-center font-weigth-bolder mb-3" }, [
        ...
        ? _c("div", [
            _vm.person == null
              ? _c(
                  ...
                  {
                    staticClass:
                      " col p-0 m-0 d-flex align-items-end flex-wrap",
                  },
                  [
                    _c("customSelect", {
                      staticClass: "ww-100A",
              ...
              : _c("div", [
                  _c(
                    "div",
                    { staticClass: "d-flex flex-wrap col p-0 m-0 mt-1" },
                    [
                      _c(
                        "div",
                        {
                          staticClass:
                            "d-flex flex-wrap col p-0 m-0 justify-content-between",
                        },
                        [
                          _c(
                            "p",
