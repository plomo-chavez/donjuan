...
var render = function () {
  ...
  return _c("div", { staticClass: "bg-video" }, [
    _c(
      ...
      [
        _c("source", {
          attrs: { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '../videos/tuvideo.mp4'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())), type: "video/mp4" },
        }),
      ]
    ),
    _vm._v(" "),
