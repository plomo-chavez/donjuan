...
/* harmony import */ var _resources_scss_vue_libs_vue_sweetalert_scss__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @resources/scss/vue/libs/vue-sweetalert.scss */ "./resources/scss/vue/libs/vue-sweetalert.scss");
/* harmony import */ var _resources_scss_vue_libs_vue_sweetalert_scss__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_resources_scss_vue_libs_vue_sweetalert_scss__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  methods: {
    ...
    buscarPorPropiedad: function buscarPorPropiedad(array, propiedad, valor) {
      if (!array || array.length === 0) {
        // Verifica si el array es nulo/undefined o está vacío
        return false;
      } else {
        return !!array.find(function (elemento) {
          return elemento[propiedad] === valor;
        }); // Usa !! para convertir el resultado a booleano
      }
    },
    eliminarElemento: function eliminarElemento(array, valor) {
      var tipo = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'indice';
      var indice;
      ...
      if (criterio == "indice") {
        ...
        indice = array.findIndex(function (elemento) {
          return elemento[criterio] === valor;
        });
      }
    ...
    formatoFechaYMD: function formatoFechaYMD(value) {
      ...
      var fechaFormateada = value != null ? fecha.toISOString().slice(0, 10).replace(/-/g, "/") : null;
      return fechaFormateada;
    },
    formatoFechaBD: function formatoFechaBD(value) {
