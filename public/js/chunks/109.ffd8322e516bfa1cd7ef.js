...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mixins: [_core_mixins_ui_forms__WEBPACK_IMPORTED_MODULE_9__["togglePasswordVisibility"], _helpers_customHelpers__WEBPACK_IMPORTED_MODULE_4__["default"]],
  data: function data() {
    return {
      status: '',
      password: 'demo123',
  ...
  methods: {
    login: function login() {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_7__["default"].login({
            ...
            if (data.result) {
              ...
              _store_index__WEBPACK_IMPORTED_MODULE_10__["default"].commit('app/UPDATE_USERDATA', userData);
              localStorage.setItem('tk', data.data.user.token);
              _this.$ability.update(userData.ability);
              console.log(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_11__["getHomeRouteForLoggedInUser"])(userData.role));
              ...
              _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_11__["getHomeRouteForLoggedInUser"])(userData.role)).then(function () {
                _this.$toast({
                  ...
                  props: {
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: "Ha iniciado sesi\xF3n exitosamente como ".concat(userData.role, ". \xA1Ahora puedes empezar a explorar!")
                  }
                });
              });
            } else {
