  ...
  data: function data() {
    return {
      steps: [{
        ...
        activeIcon: '/path/to/your/activeIcon1.svg'
      }, {
        title: 'Habitaciones',
        icon: '/path/to/your/icon2.svg',
        activeIcon: '/path/to/your/activeIcon2.svg'
      }, {
        title: 'Acompañantes',
        icon: '/path/to/your/icon3.svg',
        activeIcon: '/path/to/your/activeIcon3.svg'
      }, {
        title: 'Pago',
        icon: '/path/to/your/icon4.svg',
        activeIcon: '/path/to/your/activeIcon4.svg'
      }]
    };
  }
});
...
// Module
exports.push([module.i, "\n.steps-container[data-v-3ff92a26] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.step[data-v-3ff92a26] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.step-icon-container[data-v-3ff92a26] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 40px;\n  height: 40px; /* Default background color */\n}\n[dir] .step-icon-container[data-v-3ff92a26] {\n  border-radius: 50%;\n  background-color: #ccc;\n}\n.step.active .step-icon-container[data-v-3ff92a26],\n.step.completed .step-icon-container[data-v-3ff92a26] { /* Active/Completed step color */\n}\n[dir] .step.active .step-icon-container[data-v-3ff92a26], [dir] .step.completed .step-icon-container[data-v-3ff92a26] {\n  background-color: #007bff;\n}\n.step-icon[data-v-3ff92a26] {\n  display: flex;\n}\n.step-title[data-v-3ff92a26] {\n  color: #666; /* Default text color */\n}\n[dir] .step-title[data-v-3ff92a26] {\n  margin-top: 8px;\n  text-align: center;\n}\n.step.active .step-title[data-v-3ff92a26],\n.step.completed .step-title[data-v-3ff92a26] {\n  color: #007bff; /* Active/Completed text color */\n}\n.step-line[data-v-3ff92a26] {\n  position: absolute;\n  width: 100%;\n  height: 4px; /* Default line color */\n  /* z-index: -1; */\n}\n[dir] .step-line[data-v-3ff92a26] {\n  background-color: #ccc;\n}\n.step.completed + .step .step-line[data-v-3ff92a26] { /* Completed line color */\n}\n[dir] .step.completed + .step .step-line[data-v-3ff92a26] {\n  background-color: #007bff;\n}\n", ""]);
// Exports
      ...
      return _c(
        "div",
        {
          ...
          class: {
            ...
            completed: index < _vm.currentStep,
          },
        },
        [
          _c("div", { staticClass: "step-icon-container" }, [
            _c("div", { staticClass: "step-icon" }, [
              index !== _vm.currentStep
                ? _c("img", { attrs: { src: step.icon, alt: "" } })
                : _c("img", { attrs: { src: step.activeIcon, alt: "" } }),
            ]),
          ]),
          _vm._v(" "),
