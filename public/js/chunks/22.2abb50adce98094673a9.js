...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleSubmit: function handleSubmit(data, index) {
      ...
      this.formnularios[index] = this.copyObject(data);
    },
    handleEliminar: function handleEliminar(index) {
      this.eliminarElemento(this.formularios, index);
    },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                console.log('this.acompaniantes => ', _this.acompaniantes);
                console.log('this.formiularios => ', _this.formularios);
                if (todosValidos) {
                  _context.next = 13;
                  break;
                }
