...
/* harmony default export */ __webpack_exports__["default"] = (_directives$mixins$co = {
  directives: {
  ...
  components: {
    ...
    VuexyLogo: _core_layouts_components_Logo_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
...
}, Object(_Users_plomo_Documents_MAMP_donjuan_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_directives$mixins$co, "mixins", [_core_mixins_ui_forms__WEBPACK_IMPORTED_MODULE_10__["togglePasswordVisibility"]]), Object(_Users_plomo_Documents_MAMP_donjuan_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_directives$mixins$co, "data", function data() {
  return {
    status: '',
    password: 'demo123',
...
}), Object(_Users_plomo_Documents_MAMP_donjuan_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_directives$mixins$co, "computed", {
...
}), Object(_Users_plomo_Documents_MAMP_donjuan_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_directives$mixins$co, "methods", {
  login: function login() {
    var _this = this;
    this.loading();
    this.$refs.loginForm.validate().then(function (success) {
      if (success) {
        _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_8__["default"].login({
          ...
          if (data.result) {
            ...
            _store_index__WEBPACK_IMPORTED_MODULE_11__["default"].commit('app/UPDATE_USERDATA', userData);
            localStorage.setItem('tk', data.data.user.token);
            _this.$ability.update(userData.ability);
            console.log(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_12__["getHomeRouteForLoggedInUser"])(userData.role));
              ...
              _c(
                ...
                [
                  ...
                  _c("b-card-text", { staticClass: "mb-2" }, [
                    _vm._v(
                      "\n          Para acceder a todas las increíbles funcionalidades, ingresa tus credenciales de acceso.\n        "
                    ),
                  ]),
                  _vm._v(" "),
...
module.exports = "/images/_/_/_/_/donjuan/resources/js/src/assets/images/pages/login-v2-dark.svg";
...
module.exports = "/images/_/_/_/_/donjuan/resources/js/src/assets/images/pages/login-v2.svg";
